...
import terrainVertexShader from './Shaders/Terrain/vertex.vert'
import terrainFragmentShader from './Shaders/Terrain/fragment.frag'
import cloudVertexShader from './Shaders/Terrain/cloudVertex.vert'
import cloudFragmentShader from './Shaders/Terrain/cloudFragment.frag'
...
//Cloud
const cloudGeometry = new THREE.PlaneGeometry(10,10,16,64)
cloudGeometry.rotateX(-Math.PI * 0.5)
